...
describe("Alerts", () => {
    ...
    it("JS Confirm Alert - 'OK' button", () => {
        ...
        //NOTE - by default, Alert window automatically closed by cypress by using "OK button". 
    ...
    it("JS Confirmation Prompt Alert : OK button", () => {
        ...
        //By default, cypress will automatically close prompted alert window by using OK button.
